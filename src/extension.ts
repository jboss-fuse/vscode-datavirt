...
import { createEnvironmentVariableCommanForConfigMap, createEnvironmentVariableCommanForValue, createEnvironmentVariableCommanForSecret } from './commands/CreateEnvironmentVariableCommand';
...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.commands.registerCommand('datavirt.create.envvar.value', createEnvironmentVariableCommanForValue));
	context.subscriptions.push(vscode.commands.registerCommand('datavirt.create.envvar.secret', createEnvironmentVariableCommanForSecret));
	context.subscriptions.push(vscode.commands.registerCommand('datavirt.create.envvar.configmap', createEnvironmentVariableCommanForConfigMap));
